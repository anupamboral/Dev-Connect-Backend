...
const USER_SAFE_DATA =
  "firstName lastName about age gender skills photoUrl isPremiumUser membershipType"; //* fields which are safe to send to frontend without password and emailId
